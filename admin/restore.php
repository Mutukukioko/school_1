...
if(!$conn){
    die("Connection failed: ".mysqli_fetch_array_error());
}
...
if(isset($_POST['submit'])){
  if($user=='root' && $h=="localhost"){
     $filename='masenodb_backup_1646992163.sql';
    ...
    }else {  echo '<script>alert("You are not allowed to restore the database")</script>';}
 }
        ...
        <div class="col-12 col-sm-6">
          <div class="card card-success">
             ...
             <form action="<?php $_SERVER["PHP_SELF"];?>" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-success"name="submit">RESTORE DATABASE</button>
                </div>
              </form>
...
<!-- overlayScrollbars -->
<script src="../build/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="../build/js/adminlte.js"></script>

<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="../build/js/jquery.mousewheel.js"></script>
<script src="../build/js/raphael.min.js"></script>
<script src="../build/js/jquery.mapael.min.js"></script>
<script src="../build/js/usa_states.min.js"></script>
<!-- ChartJS -->
...
<script src="../build/js/dashboard2.js"></script>
</body>
</html>
